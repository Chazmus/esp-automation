...
def test_alert_manager_extensibility():
    ...
    readings = {"canopy": (22.0, 50.0), "soil_moisture": 12.0}
...
def test_alert_manager_dual_sensors():
    ...
    readings = {"sensor1": (22.0, 50.0), "sensor2": (32.0, 45.0)}
